...
class MainActivity : AppCompatActivity() {
        ...
        txtDOB.setOnClickListener(){
            ...
            val dpd=DatePickerDialog(this,
                ...
                year.toString())
                    ...
                    val theAge = currentYear - year
                    val minSaving = getSaving(theAge)
                    //val minSaving= getString(theAge)
                    //minSaving.text =minSaving.toString()

                    val investment = minSaving * 0.30

                    txtAge.setText(theAge.toString())
    ...
    fun getSaving(theAge:Int):Double{
        when (theAge) {
